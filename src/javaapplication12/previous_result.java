 ...
 * @author rohit
 */
public class previous_result extends javax.swing.JFrame {

    /**
     * Creates new form previous_result
     */
    ...
    public previous_result(String reg_no,int sem)
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setText("Check Different Semester result");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(previous_result.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new previous_result().setVisible(true);
            }
        });
    }
